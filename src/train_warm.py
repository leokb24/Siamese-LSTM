...
from src.model import SNLIClassifier
from src.config import get_args, makedirs
...
optimizer = O.Adam(model.parameters(), lr=args.lr)

scheduler_plateau = torch.optim.lr_scheduler.ExponentialLR(optimizer, gamma=0.8)
scheduler_warmup = GradualWarmupScheduler(optimizer, multiplier=5, total_epoch=10, after_scheduler=scheduler_plateau)
